...
private:
    ...
    void populateDebugMessengerCreateInfo(VkDebugUtilsMessengerCreateInfoEXT& createInfo) {
        ...
        /// VK_DEBUG_UTILS_MESSAGE_SEVERITY_INFO_BIT_EXT：资源创建等提示性消息
        /// VK_DEBUG_UTILS_MESSAGE_SEVERITY_WARNING_BIT_EXT：关于行为的消息，该行为不一定是错误，但很可能是您应用程序中的缺陷
        /// VK_DEBUG_UTILS_MESSAGE_SEVERITY_ERROR_BIT_EXT：关于无效行为且可能导致崩溃的消息
        ...
        /// VK_DEBUG_UTILS_MESSAGE_TYPE_PERFORMANCE_BIT_EXT：可能未以最优方式使用Vulkan
    ...
    std::vector<const char*> getRequiredExtensions() {
        ...
        if (enableValidationLayers) {
            // VK_EXT_DEBUG_UTILS_EXTENSION_NAME宏，它等同于字面字符串“VK_EXT_debug_utils”
